auto.saehbgrnn<-function(y=NULL,n=NULL,xl=NULL,xnl=NULL,M=5,adapt=4000,startburnin=1000,nChains = 2,startsample=10000,thinSteps=20,DIC=FALSE)
{
  ...
  auto.saehbgrnn1<-function(y=NULL,n=NULL,x=NULL,M=5,adapt=4000,startburnin=1000,nChains = 2,startsample=10000,thinSteps=20,DIC=FALSE)
  {
    N<-length(y)
    d<-dim(x)[2]
    dataList=list(
  ...
  auto.saehbgrnn2<-function(y=NULL,n=NULL,xl=NULL,xnl=NULL,M=5,adapt=4000,startburnin=1000,nChains = 2,startsample=10000,thinSteps=20,DIC=FALSE)
  {
    N<-length(y)
    dl<-dim(x)[2]
    dnl<-dim(x)[2]
